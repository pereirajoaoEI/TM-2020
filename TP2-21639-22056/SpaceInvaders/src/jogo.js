...
function preload ()
{
	...
	this.load.image('spr_laser', 'img/qw.png');
	this.load.image('spr_laser2', 'img/qw2.png');
	...
	this.load.image('spr_escudo', 'img/escudo.png');
...
function create ()
{
	...
	logo =this.add.image(400, 20, 'logo');
	logo.setScale(0.3);
	...
	strDebug = this.add.text(400, 40, 'Space Invaders', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#08fac2'
	}).setOrigin(0.5, 0);
	strbala1 = this.add.text(200, 40, 'Chama Amarela', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#0ee212'
	}).setOrigin(0.5, 0);

	strbala1Titulo = this.add.text(200, 5, 'Laser Laranja', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#ffac3e'
	}).setOrigin(0.5, 0);
	strbala2 = this.add.text(600, 40, 'Chama Amarela', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#0ee212'
	}).setOrigin(0.5, 0);

	strbala2Titulo = this.add.text(600, 5, 'Laser Cinzento', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#ffac3e'
	}).setOrigin(0.5, 0);
	str_score = this.add.text(180, 12, '', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#FFFFFF' 
	}).setOrigin(-1.05, -1.2);
	str_lives = this.add.text(480, 12, '', {
		fontFamily: 'Verdana',
		fontSize: '20px',
		fill: '#FFFFFF' 
	}).setOrigin(0.65, -1.2);
...
function update ()
{
	...
	if(playerPodeMover == 1){
		...
		if(qtdeTiros == 1 && laser2Ativo == 0) { 
			obj_laser2 = this.add.image(obj_player.x, obj_player.y-55, 'spr_laser2').setOrigin(0.5, 0.25);
			obj_flare.visible = 1; flareTimer = 1;
			laser2Ativo = 1;
		}
		qtdeTiros++;
	...
	if (laser1Ativo === 1) {
		strbala1.setText(
			'Desativado ').style.color='#0ee212';
	}

	if (laser1Ativo != 1) {
		strbala1.setText(
			'Ativado ').style.color='#f30f0f';
	}
